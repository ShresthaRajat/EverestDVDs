...
namespace WebApplication1.Controllers
{
    ...
    public class MemberCategoriesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "CategoryId,Name,Description,TotalLoan,TotalKeepDays,Fine")] MemberCategory memberCategory)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "CategoryId,Name,Description,TotalLoan,TotalKeepDays,Fine")] MemberCategory memberCategory)
        {
            if (ModelState.IsValid)
            {
